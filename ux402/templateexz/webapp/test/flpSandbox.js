		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Carrier Collection",
									"targetURL": "#CarrierCollection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CarrierCollection-display": {
								"semanticObject": "CarrierCollection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.templateexz.templateexz",
									"url": sap.ui.require.toUrl("com/templateexz/templateexz")
								}
							}
						}
					}
