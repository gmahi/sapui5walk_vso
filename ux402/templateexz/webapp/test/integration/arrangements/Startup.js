sap.ui.define([
	"sap/ui/test/Opa5",
	"com/templateexz/templateexz/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.templateexz.templateexz.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.templateexz.templateexz",
					async: true
				},
				hash: oOptions.hash,
