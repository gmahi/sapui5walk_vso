		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Jit Jis Cockpit",
									"targetURL": "#JitJisCockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"JitJisCockpit-display": {
								"semanticObject": "JitJisCockpit",
								"action": "display",
								"description": "Jit Jis Cockpit",
								"title": "Jit Jis Cockpit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.jitjiscockpit",
									"url": sap.ui.require.toUrl("nttdata/jitjiscockpit")
								}
							}
						}
					}
