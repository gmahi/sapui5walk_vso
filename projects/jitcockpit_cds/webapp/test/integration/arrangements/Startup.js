sap.ui.define([
	"sap/ui/test/Opa5",
	"nttdata/jitcockpitcds/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("nttdata.jitcockpitcds.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "ZC_JITCOCKPIT/" + sObjectId;
