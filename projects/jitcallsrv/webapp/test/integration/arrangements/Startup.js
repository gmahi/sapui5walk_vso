sap.ui.define([
	"sap/ui/test/Opa5",
	"jitcallsrv/jitcallsrv/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("jitcallsrv.jitcallsrv.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "C_JITCallHeaderDataTP/" + sObjectId;
